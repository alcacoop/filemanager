 ...
 */
const getSorter = ({ orderBy = DEFAULT_ORDER_BY, orderDirection = DEFAULT_ORDER_DIRECTION, caseSensitive = true }) => {
  let sameTypeSorter
  ...
  switch (orderBy) {
    ...
    case ORDER_BY_MODIFIED_TIME:
      ...
      break
    default:
      throw Object.assign(new Error(`Invalid order by: ${orderBy}`), { httpCode: 400 })
  }
  ...
  switch (orderDirection) {
    ...
    case ORDER_DIRECTION_DESC:
      ...
      break
    default:
      throw Object.assign(new Error(`Invalid order direction: ${orderDirection}`), { httpCode: 400 })
  }
...
const setupFilemanager = config => {
  encodeFn = config.encodeFn
  decodeFn = config.decodeFn
}
